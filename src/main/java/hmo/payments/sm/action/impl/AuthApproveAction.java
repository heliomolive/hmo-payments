...
@Log4j2
@Component
public class AuthApproveAction implements PaymentAction {
    ...
    public void execute(StateContext<PaymentState, PaymentEvent> context) {
        ...
        log.info("Executing AuthApproveAction for payment [{}]", paymentId);

        paymentService.authApproved(paymentId);
    }
}
