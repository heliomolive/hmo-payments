...
@Log4j2
@Component
public class PaymentCancelAction implements PaymentAction {
    ...
    public void execute(StateContext<PaymentState, PaymentEvent> context) {
        ...
        log.info("Executing PaymentCancelAction for payment [{}]", paymentId);

        paymentService.paymentCancelled(paymentId);
    }
}
